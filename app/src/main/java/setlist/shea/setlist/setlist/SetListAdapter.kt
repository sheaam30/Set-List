 ...
 */
class SetListAdapter(private var listActionListener: (SetList, SetListActions.ListAction) -> Unit): RecyclerView.Adapter<SetListAdapter.SetListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): SetListViewHolder {
        ...
        setListViewHolder.bottomWrapper.setOnClickListener({ listActionListener(setLists[setListViewHolder.adapterPosition], SetListActions.ListAction.Delete(setListViewHolder.adapterPosition))})
        setListViewHolder.container.setOnClickListener({ listActionListener(setLists[setListViewHolder.adapterPosition], SetListActions.ListAction.Click()) })
